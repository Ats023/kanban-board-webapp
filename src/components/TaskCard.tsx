        ...
        <div className="text-2xl font-semibold text-gray-900">
            { isEditingTitle? (
                ...
                <div className="flex flex-row justify-between items-baseline">
                    ...
                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="red" className="flex-none w-4 h-4 hover:cursor-pointer hover:w-5 hover:h-5">
